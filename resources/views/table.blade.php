                    ...
                    <tbody>
                        @for ($i = 1; $i <= 20; $i++)
                            <tr>
                                ...
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Nama</td>
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Tempat, Tanggal Lahir</td>
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - TMT</td>
                                
                                <!-- Gaji Pokok columns -->
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Pokok 1</td>
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Pokok 2</td>
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Pokok 3</td>
                                
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Tunjangan</td>
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Jumlah Kotor</td>
                                
                                <!-- Potongan columns -->
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Potongan 1</td>
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Potongan 2</td>
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Potongan 3</td>
                                
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - Jumlah Bersih</td>
                                <td class="px-4 py-2 border border-gray-300">Row {{ $i }} - TTD</td>
                            </tr>
                        @endfor
                    </tbody>
                </table>
