              ...
              <a href="{{ route('header.index') }}" class="max-w-max flex items-center my-4 px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-800"><i class="fas fa-arrow-left text-lg text-gray-100 mr-1"></i> kembali</a>
                ...
                <section class="flex justify-between items-start">
                  ...
                  <div class="flex gap-4">
                    <a href="{{ route('employee.createKantor', ['from' => 'kantor 1','bulan' => request('bulan'),'tahun' => request('tahun')]) }}" class="flex items-center my-4 px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-800"><i class="fas fa-plus mr-2"></i>Buat baru</a>
                    ...
                    <table class="min-w-full table-auto border-collapse text-[0.8rem]">
                        <thead>
                            <tr>
                              ...
                              <th class="py-2 border border-black bg-gray-300 w-[150px]">Uang Makan (Rp.)</th>
                              <!-- Jumlah Kotor -->
                              <th  class="py-2 border border-black bg-gray-300">Total Gaji (Rp.)</th>
                              {{-- <th class="py-2 border border-black bg-gray-300 w-[150px]">BPJS</th> --}}
                               <!-- Sub-columns for Potongan -->
                               <th class="py-2 border border-black bg-gray-300 w-[120px]">Kredit/kasbon (Rp.)</th>
                              ...
                              <!-- Jumlah Bersih -->
                              <th  class="py-2 border border-black bg-gray-300">Jumlah Gaji Bersih (Rp.)</th>
                              <!-- TTD -->
